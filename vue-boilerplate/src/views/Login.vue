            ...
            <div class="box">
                ...
                <div class="r-inputField">
                    ...
                    <div class="r-hasIcon-right r-md-size">
                        <input class="r-input" type="text" v-model="user.username" :class="error.username ? 'r-danger-outline' : ''" @keyup="error.username = false" @keypress.enter="submitLogin()">
                    </div>
                    <div class="r-danger-text r-error-label" :style="error.username ? 'opacity: 1 !important;': ''">
                        {{errorMsg.username}}
                    </div>
                </div>
                <div class="r-inputField">
                    ...
                    <div class="r-hasIcon-right r-md-size">
                        <input class="r-input" :type="showpassword ? 'text' : 'password'" v-model="user.password"  :class="error.password ? 'r-danger-outline' : ''" @keyup="error.password = false" @keypress.enter="submitLogin()">
                    ...
                    <div class="r-danger-text r-error-label" :style="error.password ? 'opacity: 1 !important;': ''">
                        {{errorMsg.password}}
                    </div>
                </div>
...
export default {
    ...
    methods:{
        ...
        async submitLogin() {
            ...
            var status = this.$store.getters['auth/getStatus']
            var msg = this.$store.getters['auth/getMsg']
            if(status == 0){
